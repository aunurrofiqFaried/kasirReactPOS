...
export default class Hasil extends Component {
    ...
    handleShow = (menuKeranjang) => {
        this.setState({
            ...
            keterangan: menuKeranjang.katerangan,
    ...
    handleSubmit = (event) => {
        ...
        const data = {
            ...
            ketarangan: this.state.keterangan,
        }
        ...
        axios
            ...
            .then(res => {
                ...
                swal({
                    ...
                    text: "Sukses Update Pesananan" + data.product.nama,
                    icon: "success",
                    button: false,
                    timer: 1500,
                });
    ...
    hapusPesanan = (id) => {
        ...
        axios
            ...
            .then(res => {
                ...
                swal({
                    title: "Hapus Pesanan",
                    text: "Sukses Hapus Pesananan" + this.state.keranjangDetail.product.nama,
                    icon: "error",
                    button: false,
                    timer: 1500,
                });
